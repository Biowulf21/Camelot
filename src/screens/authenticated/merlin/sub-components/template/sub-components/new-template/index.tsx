    ...
    <Container fluid>
      <Row className="mx-2 my-2">
        <Col className="col-md-6">
          <InputGroup>
            ...
            <Form.Control
              onChange={(event) => handleEditTemplateTitle(event.target.value)}
              placeholder="Enter Your New Template's Title"
            ></Form.Control>
          </InputGroup>
        </Col>
      </Row>
      <Row className="mx-2 my-2">
        <Col className="col-md-6">
          <InputGroup>
            ...
            <Form.Control
              onChange={(event) =>
                handleEditTemplateSubject(event.target.value)
              }
              placeholder="Enter Your New Template's Subject"
            ></Form.Control>
          </InputGroup>
        </Col>
      </Row>
      <Row className="editor-div mx-2 mb-2 justify-content-center">
        <Col className="markdown-editor col-md-6 col-sm-3 col-xs-12 px-0">
          <Form.Control
            onChange={(event) => handleEditTemplateBody(event.target.value)}
            className="editor-textarea mx-0"
            as="textarea"
          ></Form.Control>
        </Col>
      ...
      <div className="save-div mx-2 my-0">
        ...
        <div>
          <Button onClick={() => navigate("/merlin")} variant="secondary">
            Cancel
          </Button>
          <Button
